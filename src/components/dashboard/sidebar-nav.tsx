...
const navItems = {
  ...
  supervisor: [
    { href: '/dashboard/admin?tab=stationery_orders', icon: ClipboardCheck, label: 'Stationery Orders' },
    { href: '/dashboard/admin?tab=stationery', icon: BookMarked, label: 'Stationery Items' },
  ],
  manager: [
